package milkman.sio.shaded.v09.client;

import milkman.sio.shaded.v09.client.Manager.Options;
import milkman.sio.shaded.v09.client.Manager.ReadyState;
import milkman.sio.shaded.v09.client.On.Handle;
import milkman.sio.shaded.v09.emitter.Emitter;
import milkman.sio.shaded.v09.hasbinary.HasBinary;
import milkman.sio.shaded.v09.parser.Packet;
import milkman.sio.shaded.v09.parser.Parser;
import milkman.sio.shaded.v09.thread.EventThread;
        ...
        EventThread.exec(new Runnable() {
            ...
            public void run() {
                ...
                if (_args.get(_args.size() - 1) instanceof Ack) {
                    ...
                    acks.put(ids, (Ack)_args.remove(_args.size() - 1));
