...
import milkman.sio.shaded.v1.client.IO;
import milkman.sio.shaded.v1.client.IO.Options;
import milkman.sio.shaded.v1.client.Socket;
...
public class SocketIoV1Client implements SocketIoClient {
    ...
    @Builder
    static SocketIoV1Client create(
            URI serverUri,
        ...
        return new SocketIoV1Client(socket);
    }

    public static class SocketIoV1ClientBuilder implements SocketIoClientBuilder {
