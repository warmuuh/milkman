...
public class ExecutionListenerManager {
	private final Map<String, Map<String, ExecutionListenerAware.ExecutionListener>> listeners = new HashMap<>();

	public void listenOnExecution(RequestContainer request, String listenerId, ExecutionListenerAware.ExecutionListener listener) {
