...
//import io.github.palexdev.materialfx.controls.enums.Styles.ComboBoxStyles;
...
///**
// * monkeypatched to introduce getValueFromItem, protected listView
// */
//
///**
...
//    protected final MFXFlowlessListView<T> listView;
...
//        listView.setCellFactory(item -> new MFXFlowlessListCell<T>(listView, item){
//            @Override
//            protected void render(T data) {
//                String text = getValueFromItem(data);
//                setEmpty(text.isEmpty());
...
//        };
//
//        if (comboBox.getComboStyle() != ComboBoxStyles.STYLE2) {
...
//            if (newValue == ComboBoxStyles.STYLE2) {
...
//        arrowAnimation = TimelineBuilder.build()
...
//            }
//            valueLabel.setText(getValueFromItem(item));
//        } else {
//            valueLabel.setText(getValueFromItem(item));
//        }
//    }
...
//
//        double extraX = getSkinnable().getComboStyle() == ComboBoxStyles.STYLE3 ? 5 : 3;
