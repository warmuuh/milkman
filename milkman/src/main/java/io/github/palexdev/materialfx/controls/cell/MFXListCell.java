    ...
    private void addListeners() {
        ...
        selectedProperty().addListener((observable, oldValue, newValue) -> {
            if (newValue) {
                ...
                NodeUtils.updateBackground(this, Color.WHITE, new CornerRadii(getCornerRadius()), new Insets(getBackgroundInsets()));
            }
        });
        ...
        hoverProperty().addListener((observable, oldValue, newValue) -> {
            ...
            if (newValue) {
                if (getIndex() == 0) {
                    ...
                    NodeUtils.updateBackground(this, getHoverColor(), new CornerRadii(getCornerRadius()), new Insets(getBackgroundInsets()));
                }
            } else {
                NodeUtils.updateBackground(this, Color.WHITE, new CornerRadii(getCornerRadius()), new Insets(getBackgroundInsets()));
            }
        ...
        selectedColor.addListener((observableValue, oldValue, newValue) -> {
            if (!newValue.equals(oldValue) && isSelected()) {
                NodeUtils.updateBackground(this, newValue);
            }
        });
