...
//            log.error("Failed to call method by reflection. skipping ({})", e.getMessage());
//            return new ObjectProperty<Paint>() {
//                @Override
//                public void bind(ObservableValue<? extends Paint> observableValue) {
//
//                }
//
//                @Override
...
//
//                @Override
//                public void addListener(ChangeListener<? super Paint> changeListener) {
//
//                }
//
//                @Override
//                public void removeListener(ChangeListener<? super Paint> changeListener) {
//
//                }
//
//                @Override
